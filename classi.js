...
// if (!cv.xmodules) {
//   throw new Error('exiting: opencv4nodejs compiled without xmodulesxmodules module');
// }
// if (!cv.xmodules.dnn) {
...
const inceptionModelPath = './data/inception5h';
// const modelFile = `${inceptionModelPath}/tensorflow_inception_graph.pb`;
// const classNamesFile = `${inceptionModelPath}/imagenet_comp_graph_label_strings.txt`;
...
const testData = [
  {
    image: './data/images/banana.jpg',
    label: 'banana'
  },
  {
    image: './data/images/husky.jpg',
    label: 'husky'
  },
  {
    image: './data/images/car.jpeg',
    label: 'car'
  },
  {
    image: './data/images/lenna.png',
    label: 'lenna'
  },
  {
    image: './data/cars.jpeg',
    label: 'carr'
  }
];
